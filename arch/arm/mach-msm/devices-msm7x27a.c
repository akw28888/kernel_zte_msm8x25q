	...
	if (cpu_is_msm8625()) {
		...
		kgsl_3d0_pdata.pwrlevel[0].bus_freq = 200000000;
			...
			kgsl_3d0_pdata.num_levels = 5;
                        ...
                        kgsl_3d0_pdata.pwrlevel[0].gpu_freq = 550000000;
			...
			kgsl_3d0_pdata.pwrlevel[2].bus_freq = 300000000;

			kgsl_3d0_pdata.pwrlevel[3].gpu_freq = 245760000;
			kgsl_3d0_pdata.pwrlevel[3].bus_freq = 160000000;

			kgsl_3d0_pdata.pwrlevel[4].gpu_freq = 133000000;
			kgsl_3d0_pdata.pwrlevel[4].bus_freq = 0;
	}
